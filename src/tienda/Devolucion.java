...
public class Devolucion {
    ...
    //Metodo devolver peliula
    public void devolucion(){
        int idPeli;
        int idCliente;
        boolean peliculaExiste=false;
        boolean clienteExiste=false;
        idPeli=IngresoDatos.getEntero("Ingrese Id de la pelicula a devolver: ",false);
        idCliente=IngresoDatos.getEntero("Ingrese Id de cliente que devuelve la pelicula: ",false);
