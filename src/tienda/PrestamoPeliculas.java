...
public class PrestamoPeliculas {
    ...
    public  void alquiler(){
        ...
        idPeli=IngresoDatos.getEntero("Ingrese Id de la pelicula por alquilar: ",false);
        idCliente=IngresoDatos.getEntero("Ingrese Id de cliente que alquila la pelicula: ",false);
            ...
            for(int i=0;i<VectorPeliculas.getContador();i++){
                for(int j=0;j<VectorClientes.getSiguienteCodigo();j++){
                    if(VectorPeliculas.getPeliculas()[i].getId()==idPeli && VectorClientes.getClientes()[j].getId()==idCliente){
                        ...
                        vecesPrestadas[i]++;
                        prestadas[contador]="Id Pelicula: "+idPeli+"...     Id Cliente: "+idCliente+"...     Dias de Alquiler: "+dias;
